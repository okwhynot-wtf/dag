...
DAG hybrid **v0.2.5** — `corpus_not_universal` (Lawvere self-reference:
seal_self, deficit, lag, ω≠rung); MetaProblem quantitative columns.
Prior: O-2/O-4 linkage; RE growth; Born no-go; T-2 classified.
