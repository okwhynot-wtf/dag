...
PACKAGES = {
    "spine": ["Orbit", "TwoCycle", "Facticity", "Ambient", "Diagonal",
              ...
              "Information", "Observer", "NoExterior", "Faces", "Density",
              "NonCommencement", "OmegaDuration", "SelfReference", "SelfArticulation"],
    "ledger": ["Geom.Core", "Geom.Registration", "Geom.Ledger",
               "Geom.Exhaustion", "Geom.Provision", "Geom.Bounce",
               "Geom.Profile", "Geom.Gradient", "Geom.Totality",
               "Geom.Freshness", "Geom.Arc",
               "Obs.AbstractMemory", "Obs.MergeMonotone",
               "Obs.EffectiveDynamics", "Obs.Unlock",
               "Obs.UnlockCompleteness", "Obs.UnlockPricing",
               "Obs.Recovery", "Obs.CausalOrder", "Obs.Dimension",
               "Obs.Selection", "Obs.StochasticUnlock",
               "Obs.TotalVariationDPI", "Obs.StochasticDivergence",
    ...
    "bridge": ["Alphabet", "Capacity", "OneZ2", "KernelAdmit",
               ...
               "ArchiveMonotone", "BranchNondeterminism", "BranchMeasure", "LadderGrowth",
